...
public class ClienteDao extends Dao<Cliente> implements Serializable {
    ...
    public List<Cliente> findByName(String nome) {
        ...
        try {
            List<Cliente> list = em.createQuery("SELECT o FROM Cliente o where o.pessoa.nome LIKE '%" + nome + "%'").getResultList();
            return list;
        } catch (Exception e) {
            return null;
        }
    ...
    public Cliente findByNameUnit(String nome) {
        ...
        try {
            Cliente cliente = (Cliente) em
                    .createQuery(
                            "SELECT o FROM Cliente o where o.pessoa.nome LIKE '%" + nome + "%'").getSingleResult();
            return cliente;
        } catch (Exception e) {
            return null;
        }
    ...
    public Cliente findPrimaryKey(Integer id) {
        ...
        try {
            Cliente cliente = (Cliente) em
                    .createQuery(
                            "SELECT u from Cliente u where u.id = :id")
